describe('Scenario 5: all yes except universal-credit-claim, no take home pay, no help and no savings', function() {
    ...
    it('£24,000 in savings - No', function() {
        cy.get('#question-heading').contains('Do you and your partner have more than £24,000 in savings, investments or property?')
        cy.get('#radio-no').click()
        cy.get('#next-button').click()
    ...
    it('Result', function() {
        ...
        cy.get('#war-pension-explanation > a').should('have.attr', 'href', 'https://www.gov.uk/government/organisations/veterans-uk')
